...
class DataProps extends Component{
  ...
  render() {
    ...
    return(
              ...
              <h5><span className='text-danger bg-dark py-2'>Master Pizza <img src= {this.props.img} width='75px' height='75px'/></span></h5>
                <div className="image">
                  <img className="image--img " src= {this.props.img}  />
                    ...
                    </div><Link to="/contact" className='btn btn-danger mt-2 mb-5'>Click Me<img src='/Pizza hut/pngwing.com (73).png ' width='40px' height='30px'/></Link>
                    </div>
                    </div>
